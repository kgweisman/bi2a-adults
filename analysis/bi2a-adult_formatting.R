...
# set working directory for india
setwd("/Users//kweisman/Documents/Research (Stanford)/Projects/BI2A/bi2a-adults/turk/run-india_03/")
...
# fix miscoding of responseCoded - NOT NEEDED FOR THIS RUN
# d_tidy$responseCoded[d_tidy$response == "definitely no"] = -3
...
# set working directory for us
setwd("/Users//kweisman/Documents/Research (Stanford)/Projects/BI2A/bi2a-adults/turk/run-us_03/")
...
d_tidy_03 = full_join(d_india_03, d_us_03) %>%
  mutate(worker_id = factor(worker_id),
         education = factor(education, 
                            levels = c("hs_diploma", 
                                       "college_some",
